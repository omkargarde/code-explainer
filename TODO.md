...
- [x] migrate to aisdk, i dont want to deal with gemini
- [ ] format the question correctly
- [ ] should be able to answer with audio again
- [ ] upload files again
...
- [ ] add questions
- [ ] added questions should be auto tagged for tech stack/topic
